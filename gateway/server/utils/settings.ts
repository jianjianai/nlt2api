...
const BOUNDS: Record<keyof GatewaySettings, Bound> = {
  ...
  affinityTtlSeconds: { min: 0, max: 86_400 },
  affinityWaitSeconds: { min: 0, max: 300 },
  rateLimitCooldownSeconds: { min: 5, max: 3_600 },
  ipBlockCooldownSeconds: { min: 30, max: 86_400 },
  ...
  proxyMaxLatencyMs: { min: 0, max: 30_000 },
  proxyMinThroughputBps: { min: 0, max: 1_000_000_000 },
...
export const DEFAULT_SETTINGS: GatewaySettings = {
  ...
  affinityWaitSeconds: 30,
  rateLimitCooldownSeconds: 60,
  ipBlockCooldownSeconds: 900,
  ...
  proxyMaxLatencyMs: 500,
  proxyMinThroughputBps: 1_048_576,
